...
{
    public class FilamentOptionConfiguration : IEntityTypeConfiguration<FilamentOption>
    {
        public void Configure(EntityTypeBuilder<FilamentOption> builder)
        {
            builder.Property(f => f.Diameter)
                .HasPrecision(18, 2);
