...
{
    /// <inheritdoc />
    public partial class AddPrinterOptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NozzleDiameter = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    UploadPhoto = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    AMS = table.Column<bool>(type: "bit", nullable: false),
                    UploadedTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrinterOptions", x => x.Id);
                });

            migrationBuilder.InsertData(
                table: "PrinterOptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Printers_PrinterOptionId",
                table: "Printers",
                column: "PrinterOptionId");

            migrationBuilder.AddForeignKey(
                name: "FK_Printers_PrinterOptions_PrinterOptionId",
                table: "Printers",
                column: "PrinterOptionId",
                principalTable: "PrinterOptions",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Printers",
                columns: new[] { "Id", "AMS", "Description", "ModelName", "NozzleDiameter", "UploadPhoto", "UploadedTime", "UserId" },
                values: new object[,]
                {
                    { 1, true, "Bambu Lab P1S with AMS for multi-color prints.", "Bambu Lab P1S", 1.75m, "https://store.bblcdn.com/s7/default/7abb7477d233498b82a02dc93dd069df/P1.jpg", new DateTime(2026, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin-user-id" },
                    { 2, false, "Reliable budget printer for starters and upgrades.", "Creality Ender 3", 1.75m, "https://m.media-amazon.com/images/I/61CndtGd6wL._AC_UF350,350_QL80_.jpg", new DateTime(2026, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin-user-id" }
                });
